// Export pages
export '/sing_in/sing_in_widget.dart' show SingInWidget;
export '/sign_up/sign_up_widget.dart' show SignUpWidget;
export '/page_step3/page_step3_widget.dart' show PageStep3Widget;
export '/page_step2/page_step2_widget.dart' show PageStep2Widget;
...
export '/workout_description/workout_description_widget.dart'
    show WorkoutDescriptionWidget;
export '/machine_description/machine_description_widget.dart'
    show MachineDescriptionWidget;
...
export '/create_workout/create_workout_widget.dart' show CreateWorkoutWidget;
export '/create_workout_next/create_workout_next_widget.dart'
