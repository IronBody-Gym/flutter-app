            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: InkWell(
                    onTap: () => setState(
                      () => _model.passW1Visibility = !_model.passW1Visibility,
                    ),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  suffixIcon: InkWell(
                    onTap: () => setState(
                      () => _model.passW2Visibility = !_model.passW2Visibility,
                    ),
                    focusNode: FocusNode(skipTraversal: true),
                    child: Icon(
                      ...
                      onPressed: () async {
                        ...
                        final usersCreateData = {
                          ...createUsersRecordData(
                            displayName: FFAppState().nombres1,
                            lastName: FFAppState().apellidos1,
                            birthDate: FFAppState().fechaNam1,
                            phoneNumber: FFAppState().phoneNum1,
                            idCard: FFAppState().idNum1,
                          ),
                          'gender': [FFAppState().gender1],
                        };
